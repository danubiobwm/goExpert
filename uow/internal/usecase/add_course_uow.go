...
import (
	...
	"github.com/danubiobwm/goExpert/uow/internal/entity"
...
func (a *AddCourseUseCaseUow) Execute(ctx context.Context, input InputUseCase) error {
	...
	return a.Uow.Do(ctx, func(uow *uow.Uow) error {
		...
		repoCategory := a.getCatecoryRepository(ctx)
...
func (a *AddCourseUseCaseUow) getCatecoryRepository(ctx context.Context) repository.CategoryRepositoryInterface {
